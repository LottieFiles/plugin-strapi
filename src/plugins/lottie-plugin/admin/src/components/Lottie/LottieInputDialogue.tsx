...
const LottieInputDialogue = ({ setIsVisible, handleSelect }) => {
  ...
  return (
    <LottieProvider>
      <LottieContext.Consumer>
        {({appData}) => (
          <BigModal onClose={() => setIsVisible(false)} labelledBy="title">
            <ModalHeader
                  ...
                  >
                    ...
                    >
                      ...
                      <Typography
                        ...
                        variant="beta"
                      >
                        Log in with your LottieFiles account to access the
                        world’s largest collection of free-to-use animations on
                        your website.
                      </Typography>
                      ...
                      <LoginButton
                        ...
                        variant="default"
                      >
                        Log in with your LottieFiles account
                      </LoginButton>
